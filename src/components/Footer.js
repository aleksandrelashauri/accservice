                ...
                <div className="flex flex-col md:flex-row justify-around gap-8">
                    <div>
                        ...
                        <ul>
                            ...
                            <div><a href="/why"><p className="mt-3 text-yellow-500  hover:text-yellow-600 duration-150">რატომ გჭირდებით</p></a></div>
                        </ul>
                    </div>
                    <div className='flex flex-col min-w-60 text-white gap-2'>
                        ...
                        <div className="flex text-yellow-400 w-full items-center gap-2 mt-2 justify-center sm:justify-start"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M12 19a6.995 6.995 0 0 1 10-6.32V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h8.08c-.05-.33-.08-.66-.08-1zM4 6l8 5 8-5v2l-8 5-8-5V6zm13.34 16-3.54-3.54 1.41-1.41 2.12 2.12 4.24-4.24L23 16.34 17.34 22z"></path></svg>offers.accservice@gmail.com</div>
