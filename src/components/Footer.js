                ...
                <div className="flex flex-col md:flex-row justify-around gap-8">
                    <div>
                        ...
                        <ul>
                            ...
                            <div><Link to="/why"><p className="mt-3 text-yellow-500  hover:text-yellow-600 duration-150">რატომ გჭირდებით</p></Link></div>
                        </ul>
                    </div>
